...
public class SavingAccount extends Account {
    ...
    public SavingAccount(String login, String password, AccountType type, BigDecimal balance, List<PixKey> pixKeys, List<Transaction> senderTransactions, List<Transaction> receiverTransactions, Customer customer, BigDecimal monthlyYieldRate) {
